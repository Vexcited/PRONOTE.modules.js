...
class ObjetApplicationSco extends ObjetApplicationProduit_1.ObjetApplicationProduit {
	...
	lancerRequeteParametres(aParametres) {
		new ObjetRequeteFonctionParametres_1.ObjetRequeteFonctionParametres(this)
			.lancerRequete({
	...
	entreeModeExclusif() {
		...
		const lEstEspaceParentEleve =
			lEtatUtilisateur.estEspaceEleve() || lEtatUtilisateur.estEspaceParent();
		const lTitreModeExclusif = lEstEspaceParentEleve
			? ObjetTraduction_1.GTraductions.getValeur(
					"ModeExclusif.TitreEntrerModeExclusifParentEleve",
				)
			: ObjetTraduction_1.GTraductions.getValeur("ModeExclusif.UsageExclusif");
