...
class DonneesListe_SelectionPublic extends ObjetDonneesListeFlatDesign_1.ObjetDonneesListeFlatDesign {
	...
	getDisabledCB(aParams) {
		...
		return (
			...
			D.nonModifiable ||
			D.refusMess ||
			(D.estUnDeploiement && !(this._options && this._options.selectionCumul))
		);
	}
	getValueCB(aParams) {
		if (
	...
	handleRencontresSepararees(aParams, aValue) {
		...
		if (
			!((_b =
				(_a = aParams.article) === null || _a === void 0 ? void 0 : _a.pere) ===
				null || _b === void 0
				? void 0
		...
		const lEleveAvecRencontresSepareesDesResponsables = (
			(_e =
				(_d = aParams.article) === null || _d === void 0 ? void 0 : _d.pere) ===
				null || _e === void 0
				? void 0
				...
				(_g =
					(_f =
						lResponsable === null || lResponsable === void 0
							? void 0
							: lResponsable.listeNumElevesResponsablePreferentiel) === null ||
					_f === void 0
						? void 0
						: _f.includes(
	...
	getTitreZonePrincipale(aParams) {
		...
		if (!D.estUnDeploiement && D.pere && D.eleves) {
			...
			if (lEleve && lEleve.matieres) {
				lLibelleMatieres =
					"<div>" + lEleve.matieres.getTableauLibelles().join(", ") + "</div>";
			}
		}
		let lIconDetaches = "";
		if (
		...
		if (D.listeNumElevesResponsablePreferentiel) {
			if (
				D.listeNumElevesResponsablePreferentiel.includes(
					(_b =
						(_a = D.pere) === null || _a === void 0 ? void 0 : _a.getNumero) ===
						null || _b === void 0
						? void 0
						: _b.call(_a),
				)
