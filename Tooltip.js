...
class Tooltip {
				...
				(_f =
					(_d =
						(_b =
							...
							? void 0
							: (_c = _b.call(_a)).replaceRCToHTML) === null || _d === void 0
						? void 0
	...
	static positionnerTooltip(aNodeSource, aNodeTooltip, aRectSource) {
		...
		if (lNodeOverflow) {
			...
			lRectSource = { left: lLeft, top: lTop, bottom: lBottom, right: lRight };
		}
		...
		if (
			...
			lPos.left = Math.max(
				this.ecartBordEcran,
				ObjetNavigateur_1.Navigateur.ecranL - lPos.width - this.ecartBordEcran,
			);
		}
	...
	static isDisabled(aNode) {
		...
		if (
			(_a =
				aNode === null || aNode === void 0 ? void 0 : aNode.hasAttribute) ===
				null || _a === void 0
				? void 0
	...
	static getNodeTooltip(aNode) {
		...
		const lIdTooltip =
			(_a =
				aNode === null || aNode === void 0 ? void 0 : aNode.getAttribute) ===
				null || _a === void 0
				? void 0
				: _a.call(aNode, Tooltip.attrId);
		if (lIdTooltip) {
			...
			if (
				...
				return { node: this.getNodeLabelTooltip(), nodeCopie: lNodeTooltip };
			}
