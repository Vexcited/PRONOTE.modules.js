...
function _creerCBEtRB(aContexteCourant, aType, aOutils) {
	...
	if (aType === TypeCBRadio.switch) {
		lClassCss =
			...
			(lEstDroite
				...
				: IEHtml_CheckboxRadio_css_1.StylesIEHtmlCheckboxRadio.iecbrbgauche);
	...
	const lHtmlLabel = IE.jsx.str(
		...
		IE.jsx.str("span", { class: lClassSpan || false, "aria-hidden": "true" }),
	...
	Object.assign(aContexteCourant.data, {
		$couleurActif: "",
		$couleurInactif: (0, AccessApp_1.getApp)().getCouleur().nonEditable.texte,
		$AvecMain: true,
	});
	for (llName in lMap) {
