...
class ObjetDonneesListeFlatDesign extends ObjetDonneesListe_1.ObjetDonneesListe {
	...
	getOrdreAriaLabelZoneCellule(aParams) {
		return [
			...
			ObjetDonneesListeFlatDesign.ZoneCelluleFlatDesign.infosSuppZonePrincipale,
	...
	avecBoutonActionLigne(aParams) {
		return (
			this.options.avecBoutonActionLigne && !this.estInterTitre(aParams.article)
		);
	}
			...
			H.push(
				IE.jsx.str(
					"div",
					{
						class: [
							"zone-deploiement",
							lNiveauParente > 0 ? `indentation-fils-${lNiveauParente}` : "",
						],
						"aria-hidden": "true",
					},
					function () {
					...
					aTabCentrale.push(
						IE.jsx.str(
							"div",
							{
								class: [
									"zone-contenu-format",
									lIconeGauche && lTitre && !lInfosSupp ? "align-center" : "",
								],
							},
							(aTabContenuFormat) => {
								if (lIconeGauche) {
									...
									aTabContenuFormat.push(
										IE.jsx.str(
											"i",
											{
												...
												"aria-label": lTitle,
												"ie-hint":
													lHintHtml && lHintHtml.html ? lHintHtml.html : false,
											},
											!MethodesObjet_1.MethodesObjet.isString(lIconeGauche)
												? lIconeGauche.html || ""
												: "",
								...
								if (lCompl) {
									...
									aTabContenuFormat.push(
										IE.jsx.str(
											"div",
											Object.assign({ class: "zone-complementaire" }, lAttrWAI),
											lCompl,
										),
									);
								}
	...
	avecMenuContextuel(aParams) {
		return (
			super.avecMenuContextuel(aParams) && this.avecBoutonActionLigne(aParams)
		);
	}
	...
	_construireBtnAction(aParams) {
		return (0, tag_1.tag)("ie-btnicon", {
			...
			tabindex: "-1",
			"ie-model": tag_1.tag.funcAttr("liste.btnEllipsisLigne", [aParams.ligne]),
...
(function (ObjetDonneesListeFlatDesign) {
	...
	(function (ZoneCelluleFlatDesign) {
		...
		ZoneCelluleFlatDesign[(ZoneCelluleFlatDesign["zoneComplementaire"] = 6)] =
			"zoneComplementaire";
