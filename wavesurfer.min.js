		...
		(e = {
						...
						(r = [
							...
							},
							{
								...
								value: function (e, t) {
									...
									return (
										(r =
											!this.params.fillParent && s < o
												? (this.params.rtl ? a.right - n : n - a.left) *
														(this.params.pixelRatio / s) || 0
												: ((this.params.rtl ? a.right - n : n - a.left) +
				...
				var p = (function (e) {
					...
					function o(e, t) {
						...
						return (
							...
							((r = i.call(this, e, t)).maxCanvasWidth = t.maxCanvasWidth),
							(r.maxCanvasElementWidth = Math.round(
								t.maxCanvasWidth / t.pixelRatio,
							)),
							(r.hasProgressCanvas = t.waveColor != t.progressColor),
							(r.halfPixel = 0.5 / t.pixelRatio),
							(r.canvases = []),
							(r.progressWave = null),
							(r.EntryClass = s.default),
							(r.canvasContextAttributes = t.drawingContextAttributes),
							(r.overlap = 2 * Math.ceil(t.pixelRatio / 2)),
							(r.barRadius = t.barRadius || 0),
							r
						);
					}
					return (
								...
								value: function (e, t, r, n) {
									...
									return this.prepareDraw(e, t, r, n, function (e) {
										var t = e.absmax,
											...
											l = e.channelIndex;
										if (!a) {
											for (var c = [], f = u.length, h = 0; h < f; h++)
												(c[2 * h] = u[h]), (c[2 * h + 1] = -u[h]);
											u = c;
										}
										void 0 !== r && i.drawLine(u, t, o, s, r, n, l),
											i.fillRect(
												0,
												o + s - i.halfPixel,
												i.width,
							...
							},
							{
								...
								value: function (e, t, r, n, i, a, s) {
									...
									this.canvases.forEach(function (s, u) {
										o.setFillStyles(s, l, c), s.drawLines(e, t, r, n, i, a);
									});
								},
							},
							{
								...
								value: function (e, t, r, n, i, a) {
									for (
										var s = Math.floor(e / this.maxCanvasWidth),
											o = Math.min(
										...
										var l = this.canvases[u],
											...
											f = {
												...
												x2: Math.min(
													e + r,
													u * this.maxCanvasWidth + l.wave.width,
												),
												y2: t + n,
											};
										if (f.x1 < f.x2) {
											var h =
													this.params.splitChannelsOptions.channelColors[a] ||
													{},
												d = h.waveColor,
												p = h.progressColor;
											this.setFillStyles(l, d, p),
												l.fillRects(
													f.x1 - c,
													f.y1,
													f.x2 - f.x1,
									...
									return a.frame(function () {
										if (e[0] instanceof Array) {
											...
											if (u.params.splitChannels) {
												...
												return (
													u.params.splitChannelsOptions.overlay ||
														u.setHeight(
															Math.max(f.length, 1) *
																u.params.height *
																u.params.pixelRatio,
														),
													u.params.splitChannelsOptions &&
														u.params.splitChannelsOptions
				...
				var f = (function (e) {
					...
					function l(e) {
						...
						return (
							...
							((t = i.call(this, e)).params = e),
							(t.sourceMediaElement = null),
							t
						);
					}
					return (
						...
						(r = [
							...
							},
							{
								key: "_load",
								value: function (e, t, r) {
									s(c(l.prototype), "_load", this).call(this, e, t, r),
							...
							},
							{
								...
								value: function (e) {
									(this.sourceMediaElement =
										this.ac.createMediaElementSource(e)),
							...
							},
							{
								...
								value: function (e, t) {
									return (
										...
										s(c(l.prototype), "play", this).call(this, e, t)
									);
								},
							},
							{
								key: "destroy",
								value: function () {
									s(c(l.prototype), "destroy", this).call(this),
			...
			743: (e, t, r) => {
				...
				Object.defineProperty(t, "__esModule", { value: !0 }),
					(t.default = void 0);
				var i,
					a = (i = r(379)) && i.__esModule ? i : { default: i },
					s = (function (e) {
						if (e && e.__esModule) return e;
						if (null === e || ("object" !== n(e) && "function" != typeof e))
							return { default: e };
					...
					return (
						...
						(r = [
							...
							},
							{
								...
								value: function (e, t, r) {
									return this.buffer
										? l(d(a.prototype), "getPeaks", this).call(this, e, t, r)
										: this.peaks || [];
								},
							},
							{
			...
			342: (e, t, r) => {
									...
									return (
										...
										r
											? ((t.onProgress = function (e) {
												...
												new Response(new ReadableStream(new s(t, n, e)), o))
											: e
									);
								})
								.then(function (e) {
									...
									throw (
										(t || (t = "HTTP error status: " + e.status), new Error(t))
									);
								})
								.then(function (e) {
				...
				var n,
					i = (n = r(399)) && n.__esModule ? n : { default: n };
				function a(e, t) {
					for (var r = 0; r < t.length; r++) {
						var n = t[r];
						(n.enumerable = n.enumerable || !1),
			...
			412: (e, t, r) => {
				...
				var n,
					i = (n = r(779)) && n.__esModule ? n : { default: n };
				e.exports = t.default;
			},
			56: (e, t) => {
				"use strict";
				...
				var k = (function (e) {
					...
					function r(e) {
						...
						if (
							...
							(n.util = i),
							(n.params = Object.assign({}, n.defaultParams, e)),
							(n.params.splitChannelsOptions = Object.assign(
								{},
								n.defaultParams.splitChannelsOptions,
								e.splitChannelsOptions,
							)),
							(n.container =
								"string" == typeof e.container
									? document.querySelector(n.params.container)
									: n.params.container),
							!n.container)
						)
						...
						if (
							(null == n.params.mediaContainer
								...
								: "string" == typeof n.params.mediaContainer
									? (n.mediaContainer = document.querySelector(
											n.params.mediaContainer,
										))
						...
						if (
							(!0 === n.params.rtl &&
								i.style(n.container, { transform: "rotateY(180deg)" }),
							n.params.backgroundColor &&
								n.setBackgroundColor(n.params.backgroundColor),
							(n.savedVolume = 0),
							(n.isMuted = !1),
							(n.tmpEvents = []),
						...
						(n.Drawer = n.params.renderer),
							"AudioElement" == n.params.backend &&
								(n.params.backend = "MediaElement"),
							("WebAudio" != n.params.backend &&
								"MediaElementWebAudio" !== n.params.backend) ||
								s.default.prototype.supportsWebAudio.call(null) ||
								(n.params.backend = "MediaElement"),
						...
						return (
							(n._onResize = i.debounce(
								function () {
									u == n.drawer.wrapper.clientWidth ||
										n.params.scrollParent ||
										((u = n.drawer.wrapper.clientWidth),
										n.drawer.fireEvent("redraw"));
								},
								"number" == typeof n.params.responsive
									? n.params.responsive
									: 100,
							)),
							p(n, v(n))
			...
			379: (e, t, r) => {
					...
					y = (function (e) {
						...
						function r(e) {
							...
							return (
								...
								((a = t.call(this)).audioContext = null),
								(a.offlineAudioContext = null),
								(a.stateBehaviors =
									(s((n = {}), d, {
										init: function () {
								...
								(a.states =
									(s((i = {}), d, Object.create(a.stateBehaviors.playing)),
									s(i, p, Object.create(a.stateBehaviors.paused)),
									s(i, v, Object.create(a.stateBehaviors.finished)),
									i)),
								(a.buffer = null),
								(a.filters = []),
								(a.gainNode = null),
								...
								},
								{
									...
									value: function () {
										...
										this.scriptNode.onaudioprocess = function () {
											...
											t >= e.getDuration()
												? (e.setState(v), e.fireEvent("pause"))
												: t >= e.scheduledPause
													? e.pause()
													: e.state === e.states.playing &&
														e.fireEvent("audioprocess", t);
										};
									},
								},
									...
									value: function (e, t) {
										if (this.buffer)
											return (
												...
												(this.lastPlay = this.ac.currentTime),
												this.state === this.states.finished && this.setState(p),
												{ start: e, end: t }
											);
									},
								},
				...
				(t.default = y), (y.scriptBufferSize = 256), (e.exports = t.default);
			},
			296: (e) => {
				function t(e, t, r) {
					var n, i, a, s, o;
