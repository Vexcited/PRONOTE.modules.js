...
class ObjetParametres extends ObjetParametresCP_1.ObjetParametresCP {
	constructor(aJSON) {
		...
		if (!this.application.getEtatUtilisateur().pourPrimaire()) {
			...
			for (
				...
				for (const lKey of MethodesObjet_1.MethodesObjet.enumKeys(
					...
					if (
						lGenre === Enumere_DomaineFrequence_1.EGenreDomaineFrequence.QZ1 ||
		...
		this.listePeriodes = new ObjetListeElements_1.ObjetListeElements().fromJSON(
	...
	initialiserCouleur() {
		...
		if (
			...
			Object.values(TypeCollectivite_1.TypeCollectivite).includes(
				(_a = this === null || this === void 0 ? void 0 : this.collectivite) ===
					null || _a === void 0
					? void 0
					: _a.genreCollectivite,
			) &&
			((_b = this === null || this === void 0 ? void 0 : this.collectivite) ===
				null || _b === void 0
				? void 0
