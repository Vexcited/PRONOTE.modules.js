exports.ObjetFenetre_ParamAppreciationsBulletinEleve = void 0;
const ObjetFenetre_1 = require("ObjetFenetre");
const ObjetListeElements_1 = require("ObjetListeElements");
const ObjetTraduction_1 = require("ObjetTraduction");
const ObjetFenetre_CategorieEvaluation_1 = require("ObjetFenetre_CategorieEvaluation");
class ObjetFenetre_ParamAppreciationsBulletinEleve extends ObjetFenetre_1.ObjetFenetre {
	constructor() {
		super(...arguments);
		...
		this.afficherPeriode = new ObjetListeElements_1.ObjetListeElements();
		this.listeCategoriesSelectionnees =
				...
				event: function () {
					const lInstance = ObjetFenetre_1.ObjetFenetre.creerInstanceFenetre(
						ObjetFenetre_CategorieEvaluation_1.ObjetFenetre_CategorieEvaluation,
						{
							pere: aInstance,
							evenement:
								aInstance._surEvenementFenetreCategories.bind(aInstance),
						},
					);
					lInstance.setDonnees({
						avecMultiSelection: true,
						avecCreation: false,
						listeCategories: aInstance.listeCategoriesSelectionnees,
					});
				},
	...
	composeContenu() {
		...
		T.push(
			IE.jsx.str(
				...
				{
					class: [
						Divers_css_1.StylesDivers.EspaceHaut,
				...
				IE.jsx.str(
					"ie-checkbox",
					{
						...
						"ie-model": "checkAfficherCategories",
					},
					IE.jsx.str(
						"span",
						{ class: "EspaceDroit" },
