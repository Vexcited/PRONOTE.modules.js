  ...
  getTabOngletsVisibles() {
    ...
    GEtatUtilisateur.listeOnglets.parcourir((aOnglet) => {
      ...
      if (lOnglet.Actif && (lOnglet.estUnOnglet || lOnglet.profondeur === 0)) {
        ...
        lOnglet.sousOnglets = GEtatUtilisateur.listeOnglets.getListeElements(
          (aElement) => {
        ...
        lOnglet.sousOnglets.parcourir((aSousOnglet) => {
          if (aSousOnglet.avecSousOnglet) {
            ...
            aSousOnglet.sousOnglets =
              GEtatUtilisateur.listeOnglets.getListeElements((aSousElement) => {
      ...
      return IE.jsx.str("ul", { class: "browser-default" }, (aTab) => {
        aOnglet.sousOnglets.parcourir((aSousOnglet) => {
          aTab.push(
            this._ajouterLigne(
              aSousOnglet,
              !aSousOnglet.sousOnglets || aSousOnglet.sousOnglets.count() === 0,
            ),
          );
        });
      });
