...
class UtilitairePageCommune {
	...
	_construire() {
		...
		lObjetImage =
			...
			GImageConnexion.getObjetImagePronote(this.parametres.genreImageConnexion);
		if (
			this.parametres.genreImageConnexion ===
			TypeArrierePlanAuthentification_1.TypeArrierePlanAuthentification
				.PersonnaliseURL
		...
		lObjetImage.couleurFondBg =
			lObjetImage.couleurFond === "" ? "" : lObjetImage.couleurFond || "white";
		lObjetImage.classImageFond =
			lObjetImage.classImageFond ||
			(lObjetImage.urlImageFond ? "" : GImageConnexion.getClassFond());
		lObjetImage.urlImageFond = lObjetImage.urlImageFond || this.urlImageFond;
		if (
			this.parametres.genreImageConnexion ===
			TypeArrierePlanAuthentification_1.TypeArrierePlanAuthentification.Louvre
		) {
			if (this.application.estEDT) {
				...
				lObjetImage.suiviLogo = lObjetImage.suiviLogo || lObjetImage.suiviLogo1;
		...
		if (
			this.parametres.genreImageConnexion ===
			TypeArrierePlanAuthentification_1.TypeArrierePlanAuthentification.Arbre
		) {
