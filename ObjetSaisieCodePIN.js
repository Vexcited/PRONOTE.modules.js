...
class ObjetSaisieCodePIN extends ObjetIdentite_1.Identite {
	...
	getNbPIN(aEtape) {
		if (
			...
			this.options.modePIN === ObjetSaisieCodePIN.ModeSaisieValiderPIN.ReInitPIN
		) {
	...
	construireVisuCode(aEtape) {
		...
		return IE.jsx.str(
			...
			IE.jsx.str(
				...
				IE.jsx.str("span", {
					"ie-html": (0, jsx_1.jsxFuncAttr)("getHtmlVisuPIN", [aEtape, lNbPIN]),
						...
						IE.jsx.str(
							...
							IE.jsx.str(
								"ie-bouton",
								{
									...
									"ie-model": (0, jsx_1.jsxFuncAttr)("btnVal", [lVal, aEtape]),
								},
								lVal,
							),
						),
							...
							? IE.jsx.str(
									...
									IE.jsx.str(
										"ie-bouton",
										{
											...
											"ie-model": (0, jsx_1.jsxFuncAttr)("btnValider", aEtape),
										},
