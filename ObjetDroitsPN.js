  ...
  get(aGenreDroit, aNumeroSemine) {
    ...
    switch (aGenreDroit) {
      ...
      case exports.TypeDroits.cours.modifierMatieresCoursEPIEtAP:
        return (
          this._droits.cours.modifierMatieresCoursEPIEtAP && !lEstEnConsultation
        );
      ...
      case exports.TypeDroits.eleves.avecAffectationElevesGroupesGAEV:
        return (
          this._droits.AvecAffectationElevesGroupesGAEV && !lEstEnConsultation
        );
      ...
      case exports.TypeDroits.communication.avecPublicationPageEtablissement:
        return (
          this._droits.avecPublicationPageEtablissement && !lEstEnConsultation
        );
      ...
      case exports.TypeDroits.stage.autoriserEditionToutesOffresStages:
        return (
          this._droits.autoriserEditionToutesOffresStages && !lEstEnConsultation
        );
      ...
      case exports.TypeDroits.cahierDeTexte.avecSaisiePieceJointe:
        return (
          this._droits.avecSaisiePieceJointeCahierDeTexte && !lEstEnConsultation
        );
      ...
      case exports.TypeDroits.compte.avecSaisieMotDePasseEleve:
        return (
          this._droits.compte.avecSaisieMotDePasseEleve && !lEstEnConsultation
        );
      ...
      case exports.TypeDroits.intendance.avecDemandeCommandes:
        return (
          this._droits.intendance.avecDemandeCommandes && !lEstEnConsultation
        );
      case exports.TypeDroits.intendance.uniquementMesCommandes:
        return (
          this._droits.intendance.uniquementMesCommandes && !lEstEnConsultation
        );
      case exports.TypeDroits.intendance.avecExecutionCommandes:
        return (
          this._droits.intendance.avecExecutionCommandes && !lEstEnConsultation
        );
      case exports.TypeDroits.intendance.avecGestionCommandes:
        return (
          this._droits.intendance.avecGestionCommandes && !lEstEnConsultation
        );
      case exports.TypeDroits.services.avecCreationSousServices:
        return (
          this._droits.services.avecCreationSousServices && !lEstEnConsultation
        );
      ...
      case exports.TypeDroits.avecSaisieAppreciationsGenerales:
        return (
          this._droits.avecSaisieAppreciationsGenerales && !lEstEnConsultation
        );
