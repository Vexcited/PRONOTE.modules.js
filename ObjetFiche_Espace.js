...
class ObjetFiche_Espace extends ObjetFiche_DesktopMobile_1.ObjetFiche_DesktopMobile {
	...
	compose() {
		...
		H.push(
			...
			ObjetStyle_1.GStyle.composeCouleurFond(this.optionsFenetre.couleurFond),
			'">',
		);
		if (this.avecBandeau) {
			H.push(
		...
		H.push(
			(0, tag_1.tag)(
				"div",
				{
					...
					"ie-draggable": this.avecDeplacementSurFiche ? "getDragFenetre" : "",
					style: "height:100%;",
					tabindex: "0",
				},
	...
	composeBandeau(AAvecBoutonFermer) {
		...
		lHtml.push(
			(0, tag_1.tag)("h1", {
				...
				"ie-draggable": this.avecDeplacementSurBandeau ? "getDragFenetre" : "",
				"ie-html": "getTitre",
				tabindex: "0",
			}),
		);
	...
	construireStructureAffichageAutre() {
		return (
			'<div ie-node="getNodeFenetre" id="' + this.idContenuFenetre + '"></div>'
		);
	}
