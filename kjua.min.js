			...
			[
				...
				function (t, r, e) {
					...
					t.exports = function (t, r, e, n) {
						var o,
							...
							a = (function (t, r, e) {
								for (
									var n = 2 < arguments.length && void 0 !== e ? e : 1,
										o = (n = Math.max(1, n));
									o <= 40;
									o += 1
								)
								...
								1 < arguments.length && void 0 !== r ? r : "L",
								2 < arguments.length && void 0 !== e ? e : 1,
							);
						return (
							a &&
								((o = a.is_dark),
						...
						a = (function () {
							function i(t, r) {
								...
								var u = t,
									...
									p = function (t, r, e) {
										for (
											var n = S.getRSBlocks(t, r), o = M(), i = 0;
											i < e.length;
											i += 1
										) {
											var a = e[i];
								...
								(h.addData = function (t, r) {
									...
									(h.make = function () {
										if (u < 1) {
											for (var t = 1; t < 40; t++) {
												for (
													var r = S.getRSBlocks(t, f), e = M(), n = 0;
													n < c.length;
													n++
												) {
													var o = c[n];
				...
				function (t, r, e) {
					...
					function a(t, r, e) {
						...
						(n = r),
							(o = e).back &&
								((n.fillStyle = o.back), n.fillRect(0, 0, o.size, o.size)),
							(function (t, r, e) {
								if (t) {
					...
					t.exports = function (t, r, e, n, o, i) {
						...
						O
							? ((p = W),
								...
								(C = !Y && !N),
								(S = !Y && !U),
								(k = !F && !U) ? p.m(y + x, w) : p.m(y, w),
								B ? p.l(m - x, w).a(m, w, m, b, x) : p.l(m, w),
								C ? p.l(m, b - x).a(m, b, y, b, x) : p.l(m, b),
								S ? p.l(y + x, b).a(y, b, y, w, x) : p.l(y, b),
								k ? p.l(y, w + x).a(y, w, m, w, x) : p.l(y, w))
							: ((u = W),
								(f = M),
								(c = A),
								(l = L),
						...
						"label" === h
							? (function (t, r) {
									...
									(t.strokeStyle = r.back),
										(t.lineWidth = 0.01 * r.mSize * e * 0.1),
									...
									var o = t.measureText(r.label).width,
										...
										u =
											(1 - i) * r.mPosY * 0.01 * e + 0.75 * r.mSize * 0.01 * e;
							...
							: "image" === h &&
								...
								(u = 0.01 * n.mSize),
								(c = (1 - (f = (u * i) / a)) * n.mPosX * 0.01 * o),
								(l = (1 - u) * n.mPosY * 0.01 * o),
								(s = f * o),
								(g = u * o),
								e.drawImage(n.image, c, l, s, g));
					};
				},
				function (t, r, y) {
					function J(n) {
					...
					t.exports = function (t, r) {
						...
						return (
							(p.style.width = "".concat(d, "px")),
							(p.style.height = "".concat(d, "px")),
							r.back &&
								p.appendChild(
									b("rect", { x: 0, y: 0, width: d, height: d, fill: r.back }),
								),
							p.appendChild(
								b("path", {
									d: (function (t, r) {
												...
												(i = t),
													...
													H
														? ((m = a),
															...
															(A = !W && !q),
															(L = !W && !V),
															(S = !E && !V) ? m.m(b + C, x) : m.m(b, x),
															M ? m.l(k - C, x).a(k, x + C, C) : m.l(k, x),
															A ? m.l(k, B - C).a(k - C, B, C) : m.l(k, B),
															L ? m.l(b + C, B).a(b, B - C, C) : m.l(b, B),
															S ? m.l(b, x + C).a(b + C, x, C) : m.l(b, x))
														: ((l = a),
															(s = D),
															(g = _),
															(h = z),
							...
							"label" === v
								? (function (t, r) {
										...
										(a.strokeStyle = r.back),
											(a.lineWidth = 0.01 * r.mSize * e * 0.1),
											(a.fillStyle = r.fontcolor),
											(a.font = n);
