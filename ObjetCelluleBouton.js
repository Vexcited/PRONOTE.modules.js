	...
	getControleur(aInstance) {
		return $.extend(true, super.getControleur(aInstance), {
			...
			getStyleConteneur: function () {
				return {
					width:
						aInstance.options.largeur && aInstance.options.largeur === "100%"
							? "100%"
							: "",
				};
			},
			...
			getAttrContenu() {
				const lAriaLabel =
					aInstance.options.ariaLabel || aInstance.options.titleForce || null;
				const lAttr = {
					...
					Object.assign(
						...
						lStrAttrsWAI,
						{
							...
							placeholder:
								...
								MethodesObjet_1.MethodesObjet.isString(this.options.placeHolder)
									? this.options.placeHolder
									: false,
						},
					),
