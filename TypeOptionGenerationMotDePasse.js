...
(function (TypeOptionGenerationMotDePasse) {
  ...
  TypeOptionGenerationMotDePasse[
    (TypeOptionGenerationMotDePasse["OGMDP_AvecAuMoinsUnCaractereSpecial"] = 2)
  ] = "OGMDP_AvecAuMoinsUnCaractereSpecial";
  TypeOptionGenerationMotDePasse[
    (TypeOptionGenerationMotDePasse["OGMDP_AvecMelangeMinusculeMajuscule"] = 3)
  ] = "OGMDP_AvecMelangeMinusculeMajuscule";
  TypeOptionGenerationMotDePasse[
    (TypeOptionGenerationMotDePasse["OGMDP_AvecControleIdentifiantDifferent"] =
      4)
  ] = "OGMDP_AvecControleIdentifiantDifferent";
})(
  TypeOptionGenerationMotDePasse ||
    (exports.TypeOptionGenerationMotDePasse = TypeOptionGenerationMotDePasse =
      {}),
);
