...
class DonneesListe_QuestionQCM extends ObjetDonneesListeFlatDesign_1.ObjetDonneesListeFlatDesign {
	...
	getInfosSuppZonePrincipale(aParams) {
		...
		if (
			...
			const lEnonceSansBaliseHtml = [];
			if (Array.isArray(lDOMAvecEnonce)) {
				lDOMAvecEnonce.forEach((aDom) => {
					lEnonceSansBaliseHtml.push(this.getTextesDeNode(aDom));
				});
			} else {
				lEnonceSansBaliseHtml.push(this.getTextesDeNode(lDOMAvecEnonce));
			}
			return IE.jsx.str(
				"div",
				{ "ie-ellipsis": true },
				lEnonceSansBaliseHtml.join(""),
			);
		}
		return IE.jsx.str("div", null);
	}
	getTextesDeNode(aElement) {
		return ObjetHtml_1.GHtml.getTextesDeNode(aElement)
			.join("")
			.trim()
			.ajouterEntites();
	}
		...
		return IE.jsx.str(
			...
			(lEnonce ||
				...
				((_d =
					lQuestion === null || lQuestion === void 0
						? void 0
						: lQuestion.url) === null || _d === void 0
					? void 0
					: _d.length) > 0) &&
				IE.jsx.str(
					"div",
					{ class: "wrapperEnonceQuestionQCM" },
					lEnonce &&
						IE.jsx.str(
							"article",
					...
					((_e =
						lQuestion === null || lQuestion === void 0
							? void 0
							: lQuestion.image) === null || _e === void 0
						? void 0
						: _e.length) > 0 &&
						IE.jsx.str(
							"article",
							...
							IE.jsx.str("img", {
								alt: "",
								src: `data:image/png;base64,${ObjetChaine_1.GChaine.supprimerRC(lQuestion.image)}`,
								onerror:
					...
					((_f =
						lQuestion === null || lQuestion === void 0
							? void 0
							: lQuestion.mp3name) === null || _f === void 0
						? void 0
						: _f.length) > 0 &&
						((_g =
							lQuestion === null || lQuestion === void 0
								? void 0
								: lQuestion.mp3) === null || _g === void 0
							? void 0
							: _g.length) > 0 &&
						IE.jsx.str(
							"article",
			...
			IE.jsx.str(
				...
				UtilitaireQCM_1.UtilitaireQCM.composeReponsesCorrigeesDeQuestion(
					...
					{ ieModelAudio: "chipsAudio", estPrevisualisation: true },
					null,
					true,
				),
			),
			lAvecInfosCompetences &&
				((_k =
					(_j =
						lQuestion === null || lQuestion === void 0
							? void 0
							: lQuestion.listeEvaluations) === null || _j === void 0
						? void 0
						: _j.count) === null || _k === void 0
					? void 0
					: _k.call(_j)) > 0 &&
				IE.jsx.str(
					"article",
