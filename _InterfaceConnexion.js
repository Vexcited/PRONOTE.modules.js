  ...
  construireStructureAffichageAutre() {
    if (this.estConnexionSansInterface()) {
      return (
        ...
        '">' +
        ObjetTraduction_1.GTraductions.getValeur("connexion.ConnexionCAS") +
        "</div>"
      );
    } else {
      ...
      getModel: {
        ...
        getTitle() {
          return ObjetTraduction_1.GTraductions.getValeur(
            "connexion.btnInterrogationTitle",
          );
        },
      },
      choixConnexion: {
        ...
        interrompreEvent: function (aEvent) {
          if (
            ...
            if (
              ...
              !aInstance.applicationProduit.getCommunication().requeteEnCours()
            ) {
