...
(function (TypeCommandeSecurisationCompteHttp) {
	...
	TypeCommandeSecurisationCompteHttp[
		(TypeCommandeSecurisationCompteHttp["csch_VerifierMotDePassePersonnalise"] =
			1)
	...
	TypeCommandeSecurisationCompteHttp[
		(TypeCommandeSecurisationCompteHttp["csch_EnregistrerChoixUtilisateur"] = 3)
	...
	TypeCommandeSecurisationCompteHttp[
		(TypeCommandeSecurisationCompteHttp["csch_RenommerSourceConnexionConnue"] =
			6)
	] = "csch_RenommerSourceConnexionConnue";
	TypeCommandeSecurisationCompteHttp[
		(TypeCommandeSecurisationCompteHttp["csch_SupprimerSourceConnexionConnue"] =
			7)
	] = "csch_SupprimerSourceConnexionConnue";
	TypeCommandeSecurisationCompteHttp[
		(TypeCommandeSecurisationCompteHttp["csch_AffecterMotDePassePersonnalise"] =
			8)
	...
	TypeCommandeSecurisationCompteHttp[
		(TypeCommandeSecurisationCompteHttp["csch_DemandeReinitialisationPIN"] = 10)
...
(function (TypeActionIHMSecurisationCompte) {
	TypeActionIHMSecurisationCompte[
		(TypeActionIHMSecurisationCompte["AIHMSC_PersonnalisationMotDePasse"] = 0)
	...
	TypeActionIHMSecurisationCompte ||
		(exports.TypeActionIHMSecurisationCompte = TypeActionIHMSecurisationCompte =
			{}),
);
...
(function (TypeModeGestionDoubleAuthentification) {
	...
	TypeModeGestionDoubleAuthentification[
		(TypeModeGestionDoubleAuthentification["MGDA_NotificationSeulement"] = 2)
...
(function (TypeGenreSourceConnexion) {
	TypeGenreSourceConnexion[(TypeGenreSourceConnexion["GSC_ClientLourd"] = 0)] =
		"GSC_ClientLourd";
	TypeGenreSourceConnexion[
		(TypeGenreSourceConnexion["GSC_ApplicationMobile"] = 1)
	] = "GSC_ApplicationMobile";
	TypeGenreSourceConnexion[(TypeGenreSourceConnexion["GSC_Navigateur"] = 2)] =
		"GSC_Navigateur";
})(
	TypeGenreSourceConnexion ||
