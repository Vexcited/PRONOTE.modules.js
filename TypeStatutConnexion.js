...
(function (TypeGenreStatutConnexion) {
  TypeGenreStatutConnexion[(TypeGenreStatutConnexion["GSC_Disponible"] = 0)] =
    "GSC_Disponible";
  ...
  TypeGenreStatutConnexion[(TypeGenreStatutConnexion["GSC_Deconnecte"] = 3)] =
    "GSC_Deconnecte";
})(
  TypeGenreStatutConnexion ||
    ...
    switch (aGenre) {
      ...
      default:
        return aAvecLibelleInvisible
          ...
          : ObjetTraduction_1.GTraductions.getValeur("Messagerie.NonConnectee");
    }
  },
};
