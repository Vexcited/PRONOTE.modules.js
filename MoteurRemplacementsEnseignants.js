...
class MoteurRemplacementsEnseignants {
			...
			if (
				...
				const lElement = ObjetElement_1.ObjetElement.create({
					...
					paramRequete: {
						...
						uniquementSiDisponible: lFiltreDefault.uniquementSiDisponible,
					},
				});
				lPos++;
	...
	initFiltre(aArticleAffichage) {
		...
		if (
			...
			(aArticleAffichage.filtre.uniquementMesMatieresClasses !==
				lFiltreDefault.uniquementMesMatieresClasses ||
				aArticleAffichage.filtre.uniquementSiDisponible !==
					lFiltreDefault.uniquementSiDisponible)
		) {
			this.actualiserDonnees = true;
			aArticleAffichage.paramRequete.uniquementMesMatieresClasses =
				lFiltreDefault.uniquementMesMatieresClasses;
			aArticleAffichage.paramRequete.uniquementSiDisponible =
				lFiltreDefault.uniquementSiDisponible;
		}
		aArticleAffichage.filtre = lFiltreDefault;
	}
	estFiltreParDefault() {
		const lFiltreDefault = this.getFiltreDefaultDeType(
		...
		switch (this.affichageCourant.getGenre()) {
			case TypeAffichageRemplacements_1.TypeAffichageRemplacements
				...
				lTestDisponible = !this.affichageCourant.filtre.uniquementSiDisponible;
				break;
			}
		}
		return (
	...
	construireSousTitre(aArticle) {
		return IE.jsx.str("div", null, aArticle.getLibelle());
	}
		...
		return IE.jsx.str(
			...
			IE.jsx.str(
				...
				ObjetTraduction_1.GTraductions.getValeur(
					"RemplacementsEnseignants.titres.Salle",
				),
				" : ",
				aArticle.salles.getTableauLibelles().join(", "),
			),
			IE.jsx.str("div", {
				class: "infoVolontaire",
				"ie-texte": this.jsxGetInfoVolontaire.bind(this, aArticle),
			}),
			IE.jsx.str(
				"div",
				{
					class: "commentaireVolontariat",
					"ie-if": this.jsxAvecCommentaire.bind(this, aArticle),
				},
				IE.jsx.str(
					"div",
					{ class: Styles_css_1.StylesStyles.Souligne },
					ObjetTraduction_1.GTraductions.getValeur(
						"RemplacementsEnseignants.titres.Commentaire",
					),
					" : ",
				),
				IE.jsx.str("div", {
					"ie-html": this.jsxGetCommentaire.bind(this, aArticle),
	...
	jsxAvecCommentaire(aRemplacement) {
		return (
			aRemplacement &&
	...
	jsxGetCommentaire(aRemplacement) {
		if (aRemplacement && aRemplacement.commentaire) {
			return aRemplacement.commentaire.replaceRCToHTML();
		}
		return "";
	}
	...
	getZoneReponse(aArticle, aParamsJSXMethodes) {
		var _a, _b, _c, _d, _e;
		switch (aArticle.getGenre()) {
			case TypeGenreCoursRemplacable_1.TypeGenreCoursRemplacable.cr_suggestion:
				return IE.jsx.str(
					"div",
					{
						class: "propositionboutons",
						role: "group",
						"ie-attr":
							(_a =
								aParamsJSXMethodes === null || aParamsJSXMethodes === void 0
									? void 0
									: aParamsJSXMethodes.getAriaLabelProposition) === null ||
							_a === void 0
								? void 0
								: _a.bind(this, aArticle),
					},
					IE.jsx.str(
						"ie-checkbox",
						{
							...
							"ie-model":
								(_b =
									aParamsJSXMethodes === null || aParamsJSXMethodes === void 0
										? void 0
										: aParamsJSXMethodes.cbProposition) === null ||
								_b === void 0
									? void 0
									: _b.bind(this, aArticle, true),
						},
						ObjetTraduction_1.GTraductions.getValeur(
					...
					IE.jsx.str("ie-bouton", {
						...
						"ie-model":
							(_d =
								aParamsJSXMethodes === null || aParamsJSXMethodes === void 0
									? void 0
									: aParamsJSXMethodes.boutonVolontaires) === null ||
							_d === void 0
								? void 0
								: _d.bind(this, aArticle),
						"ie-class":
							(_e =
								aParamsJSXMethodes === null || aParamsJSXMethodes === void 0
									? void 0
									: aParamsJSXMethodes.classBoutonVolontaires) === null ||
							_e === void 0
								? void 0
								: _e.bind(this, aArticle),
					}),
				);
