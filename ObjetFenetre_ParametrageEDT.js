        ...
        getDonnees: function (aDonnees) {
          if (!aDonnees) {
            ...
            let lElement = new ObjetElement_1.ObjetElement(
              ...
              null,
              UtilitairePrefsGrilleStructure_1.UtilitairePrefsGrilleStructure.modeles.defaut,
            );
            ...
            if (
              ...
              lElement = new ObjetElement_1.ObjetElement(
                ...
                null,
                UtilitairePrefsGrilleStructure_1.UtilitairePrefsGrilleStructure.modeles.perso,
              );
              aInstance.listeModelesGrille.addElement(lElement);
            }
    ...
    if (
      ...
      if (
        ...
        lElement = new ObjetElement_1.ObjetElement(
          ...
          null,
          TypeGranulariteGrille_1.TypeGranulariteGrille.demiPensionMatinApresMidi,
        );
        this.listeGranularites.addElement(lElement);
      }
    }
